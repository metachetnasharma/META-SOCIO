            ...
            <div class="brand-name-subtext">
                            <div class="input-group input-group-lg">
                                <span class="input-group-btn">
                                    <a href="https://accounts.google.com/o/oauth2/auth?scope=email&amp;redirect_uri=http://localhost:8080/MetaSocio/OAuth&amp;response_type=code&amp;client_id=881126743057-0u1nhaqo1uk2dl0h0e9mpe3f9ptvmsa6.apps.googleusercontent.com&amp;approval_prompt=force&hd=metacube.com"><button type="submit" name="subscribe" id="mc-embedded-subscribe" class="btn btn-primary">Sign-In with METACUBE-ID</button></a>
                                </span>
                            </div>
